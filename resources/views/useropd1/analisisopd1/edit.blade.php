...
@section('isi')
  ...
  <form class="form-horizontal" action="{{url('/useropd1/analisisopd1', $analisis->id)}}" method="POST">
    {!! csrf_field() !!}
      ...
      <div class="widget-body">
        ...
        <div class="clearfix">
          <div class="pull-right">
            ...
            <a href="{{route('transaksiopd')}}" type="submit" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-remove"></span> Batal</a>
          </div>
        </div>
