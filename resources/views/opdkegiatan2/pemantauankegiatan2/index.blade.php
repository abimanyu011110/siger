...
<div class="box">
  ...
  <div style="margin-bottom: 10px">
    ...
    <a href="pantaukegiatan" class="btn btn-primary btn-sm">
    ...
    <table id="tbl-rtp" class="table table-hover">
      <thead align="center">
        <tr>
          ...
          <th>RTP Tambahan</th>
          <th>Kemungkinan Setelah RTP</th>
          <th>Dampak Setelah RTP</th>
      ...
      @foreach($rtpkegiatan as $item)
        <tr class="item{{$item->id}}">
          ...
          @if($item->tingkat_risiko>0)
            ...
            @else
              <td><a href="pemantauankegiatan2/create/{{$item->id}}" class="btn btn-warning btn-xs">
              <span class="glyphicon glyphicon-edit"></span> Input Pemantauan</a></td>
            @endif
