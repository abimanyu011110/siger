  ...
  <div class="col-sm-12">
    <div class="widget-box">
      ...
      <div class="widget-header">
        <h4 class="widget-title">Tambah Data Visi</h4>
      </div>

      <div class="widget-body">
        <div class="widget-main">
          <form class="form-horizontal" action="{{route('visi.store')}}" method="post">
            {!! csrf_field() !!}
        ...
        <div class="form-group  @if($errors->has('nama_visi')) has-error @endif"">
          <label for="nama_visi" class="col-sm-2 control-label">Nama Visi</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" name="nama_visi" value="{{old('nama_visi')}}">
