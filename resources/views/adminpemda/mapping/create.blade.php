    ...
    <div class="widget-box">
      ...
      <div class="widget-body">
        <div class="widget-main">
          <form class="form-horizontal" action="{{route('mapping.store')}}" method="post">
            {!! csrf_field() !!}
        ...
        <div class="clearfix">
          <div class="pull-right">
            ...
            <a href="{{route('mapping.index')}}" type="submit" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Batal</a>
          </div>
        </div>
