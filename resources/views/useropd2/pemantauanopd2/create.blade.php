...
@section('isi')
  ...
  <form class="form-horizontal" action="{{url('/useropd2/pemantauanopd2')}}" method="POST">
    {!! csrf_field() !!}
  ...
  <div class="col-sm-12">
    <div class="widget-box">
      ...
      <div class="widget-body">
        ...
        <input type="hidden" name="rtpopd_id" value="{{ $kegiatan->id }}">
...
Simpan </button>
            <a href="{{route('pantauopd')}}" type="submit" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-remove"></span> Batal</a>
          </div>
        </div>
