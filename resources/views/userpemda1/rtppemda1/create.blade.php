    ...
    <div class="widget-box">
      ...
      <div class="widget-body">
        <div class="widget-main">
          <form class="form-horizontal" action="{{route('rtppemda1.store')}}" method="post">
            {!! csrf_field() !!}

              <input type="hidden" name="analisis_id" value="{{ $dt->id }}">
        ...
        <div class="form-group  @if($errors->has('penanggungjawab')) has-error @endif"">
         ...
         <div class="form-group">
          <label for="dampak" class="col-sm-3 control-label"> Nilai Dampak</label>
          <div class="col-sm-1">
        ...
        <div class="form-group">
          <label for="kemungkinan" class="col-sm-3 control-label"> Nilai Kemungkinan</label>
          <div class="col-sm-1">
        ...
        <div class="clearfix">
          <div class="pull-right">
            ...
            <a href="{{route('rtppemda1.index')}}" type="submit" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Batal</a>
          </div>
        </div>
