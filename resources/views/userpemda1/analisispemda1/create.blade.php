...
@section('isi')
  ...
  <form class="form-horizontal" action="{{url('/userpemda1/analisispemda1')}}" method="POST">
    {!! csrf_field() !!}
      ...
      <div class="widget-body">
        ...
        <div class="clearfix">
          <div class="pull-right">
            ...
            <a href="{{route('analisispemda1.index')}}" type="submit" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-remove"></span> Batal</a>
          </div>
        </div>
...
@push('js')
  ...
  $(document).ready(function() {
        ...
        $('#kegiatan_id').on('change', function() {
            ...
            if(kegID) {
                $.ajax({
                    url: '/analisispemda1/pilihRisiko/'+kegID,
                    type: 'get',
                    dataType: 'json',
