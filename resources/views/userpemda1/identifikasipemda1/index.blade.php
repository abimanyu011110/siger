...
<div class="box">
  ...
  <div style="margin-bottom: 10px">
    ...
    <a href="{{route('createnewpemda')}}" class="btn btn-primary btn-sm">
    <span class="glyphicon glyphicon-plus"></span> Tambah
    </a>

    <a href="tranIdentifikasiPemda" class="btn btn-primary btn-sm">
    ...
    <table id="tbl-identifikasi" class="table table-hover">
      ...
      @foreach($data as $item)
        <tr class="item{{$item->id}}">
          ...
          @else
            <td><a href="identifikasipemda1/create/{{$item->id}}" class="btn btn-warning btn-xs">
