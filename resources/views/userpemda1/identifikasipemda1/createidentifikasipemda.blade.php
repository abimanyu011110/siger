  ...
  <div class="col-sm-12">
    <div class="widget-box">
      ...
      <div class="widget-header">
        <h4 class="widget-title">Tambah Identifikasi Pemerintah Daerah</h4>
      </div>
      ...
      <div class="widget-body">
        ...
        <div class="clearfix">
          <div class="pull-right">
            ...
            <a href="{{route('identifikasipemda1.index')}}" type="submit" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-remove"></span> Batal</a>
          </div>
        </div>
