...
@section('isi')
    ...
    <script type="text/javascript">
      ...
      function drawChart2()
      {
        ...
        var options = {
        title: 'Tingkat Risiko, Kemungkinan, & Dampak',
        seriesType: 'bars',
        series: {3: {type: 'line'}}
      ...
      {
      	var data = google.visualization.arrayToDataTable([
          ['Nama Kegiatan', 'Tingkat Risiko'],
          @foreach ($chart as $pies)
          ['{{$pies->nama_kegiatan}}', {{$pies->tingkat_risiko}}],
          @endforeach
        ]);

        var options = {
          title: 'Kegiatan Dengan Risiko Tertinggi Di OPD',
          is3D: true,
        };
