...
@section('isi')
    ...
    <script type="text/javascript">
      ...
      function drawChart2()
      {
        ...
        var options = {
        title: 'Tingkat Risiko, Kemungkinan, dan Dampak',
        seriesType: 'bars',
        series: {3: {type: 'line'}}
    ...
    <p align="center" style="font-size:18px; font-weight: bold; font-family: sans-serif">PETA RISIKO KEGIATAN</p>
    <p align="center" style="font-size:18px; font-weight: bold; font-family: sans-serif">{{$nama_opd->nama_opd}}</p><br>
