...
@section('isi')
  ...
  <form class="form-horizontal" action="{{url('/useropdkegiatan1/rtpkegiatan1', $rtp->id)}}" method="POST">
    {!! csrf_field() !!}
      ...
      <div class="widget-body">
        ...
        <div class="clearfix">
          <div class="pull-right">
            ...
            <a href="{{route('rtpkegiatan1.index')}}" type="submit" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Batal</a>
          </div>
        </div>
