    ...
    <div class="widget-box">
      ...
      <div class="widget-body">
        <div class="widget-main">
          <form class="form-horizontal" action="{{route('identifikasikegiatan1.update', $identifikasi->id)}}" method="post">
            ...
            <label for="program_id" class="col-sm-2 control-label"> Program</label>
              <div class="col-sm-10">
               ...
               @foreach($program as $key => $value)
                <option value="{{$key}}" {{$identifikasi->program_id == $key ? 'selected' : ''}}>{{$value}}</option>
              @endforeach
                </select>
              </div>
        </div>
        ...
        <div class="form-group">
            <label for="kegiatan_id" class="col-sm-2 control-label"> Kegiatan</label>
              <div class="col-sm-10">
                ...
                <option value="{{$key}}" {{$identifikasi->kegiatan_id == $key ? 'selected' : ''}}>{{$value}}</option>
              @endforeach
                </select>
              </div>
        </div>
