...
@section('isi')
  ...
  <form class="form-horizontal" action="{{url('/userpemda2/pemantauanpemda2')}}" method="POST">
    {!! csrf_field() !!}
  ...
  <div class="col-sm-12">
    <div class="widget-box">
      ...
      <div class="widget-body">
        ...
        <input type="hidden" name="rtpopd_id" value="{{ $dt->id }}">
          ...
          <label for="tingkat_risiko" class="col-sm-2 control-label"> Tingkat Risiko RTP</label>
            <div class="col-sm-1">
              <input id="tingkat_risiko1" type="text" class="form-control" name="tingkat_risiko1"
               value="{{$dt->tingkat_risiko}}" readonly="true">
            </div>
