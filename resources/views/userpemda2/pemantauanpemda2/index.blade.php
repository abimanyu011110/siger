...
<div class="box">
  ...
  <div style="margin-bottom: 10px">
    ...
    <a href="pantaupemda" class="btn btn-primary btn-sm">
    <span class="glyphicon glyphicon-eye-open"></span> Data Pemantauan
    </a>

  </div>
  {{ csrf_field() }}
    <table id="tbl-pantau" class="table table-hover">
      <thead align="center">
        <tr>
          <th>No.</th>
      ...
      @foreach($dt as $item)
        <tr class="item{{$item->id}}">
          ...
          @if($item->tingkat_risiko>0)
            ...
            @else
              <td><a href="pemantauanpemda2/create/{{$item->id}}" class="btn btn-warning btn-xs">
